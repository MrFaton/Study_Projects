...
/*
Коллекция HashSet - это множество, основанное на хэщ-таблице. Но у этого множества нет порядка и нет дублекатов
элементов. На основании хэщ-кода элемент попадает в блок (корзину) и там сравнивается по equals с другими элементами.
Если последний вернул false, тогда элемент добавляется в коллекцию. Элементы содержаться, а следовательно и извлекаются
в том прядке, который удобен коллекции.
 */